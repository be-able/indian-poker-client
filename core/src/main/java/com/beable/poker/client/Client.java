...
//
//	public Client(@NonNull String serverAddress) {
...
//	 * @param result 성공여부
//	 */
//	public void login(@NonNull String id,
//					  @NonNull String pwd,
//					  @NonNull OnReturnListener<Boolean> result) {
...
//	 * @param result 서버문구
//	 */
//	public void createAccount(@NonNull String id,
//							  @NonNull String pwd,
//							  @NonNull String pwd2,
//							  @NonNull String nick,
//							  @NonNull OnReturnListener<String> result) {
...
//	 */
//	public void updateProfile(@NonNull String base64Image,
//							  @NonNull OnReturnListener<Boolean> result) {
...
//						@NonNull OnReturnListener<UserModel> result) {
...
//					  @NonNull OnReturnListener<RoomModel[]> result) {
...
//	 */
//	public void findRoom(@NonNull String roomName,
//						 @NonNull OnReturnListener<RoomModel[]> result) {
...
//						   @NonNull OnReturnListener<Boolean> result,
//						   @NonNull OnReturnListener<RoomModel> notify,
//						   @NonNull OnReturnListener<RoomModel> startGame) {
...
//						 @NonNull OnReturnListener<Boolean> result,
//						 @NonNull OnReturnListener<RoomModel> notify,
//						 @NonNull OnVoidListener startGame) {
//		if (this.user == null || this.user.userID == null) {
//			return;
//		}
//
...
//	}
//
//	private void joinRoomHandler(@NonNull String roomID,
...
//	 */
//	public void exitRoom(@NonNull OnReturnListener<Boolean> result) {
//		if (this.user == null || this.user.userID == null) {
//			return;
//		}
//
